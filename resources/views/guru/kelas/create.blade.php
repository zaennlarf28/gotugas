...
<div class="container-fluid mt-4">
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0 fw-semibold"><i class="bi bi-plus-circle me-1"></i> Buat Kelas Baru</h5>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('guru.kelas.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama_kelas" id="nama_kelas" class="form-control rounded" required>
                </div>
                <div class="mb-3">
